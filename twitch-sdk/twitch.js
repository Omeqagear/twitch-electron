...
(function() {
    ...
    var redirectRegex = /<pre .+?>(.+)<\/pre>/g;

    ipc.on("html", function (_, html) {
      ...
      win.webContents.executeJavaScript("require('electron').ipcRenderer.send('html', document.body.innerHTML)");
